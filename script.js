...
// // Only direct siblings are allowed, either previous of next
...
const slider = function () {
  ...
  const createDots = function () {
    // _ is the 'slide' parameter, it's not needed so I use a throwaway _
...
document
  ...
  .addEventListener('click', function () {
    // message.parentElement.removeChild(message) // what it used to be
    message.remove();
  });
...
// Capturing and Bubbling==> Propagation
